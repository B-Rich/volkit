/*******************************************************************************
  ...
  2005-04-05 version 1.0 (krs) Roman Krais
     First created, with function interfile_read().
  2009-02-26 VO
     fread() cast with (void) to prevent compiler warnings.
  2009-03-04 VO
     fread() return value is verified.
  2011-09-13 VO
     Array subscript was above array bounds, now fixed.
  2012-02-22 Vesa Oikonen
     Added functions interfileIsHeader() and interfileExists().
