/*******************************************************************************
  ...
  Library:      img_sif
  Description:  Functions for copying data from IMG to SIF and vice versa.
  ...
  2013-04-04 Vesa Oikonen
    Contents moved from img_ana.c and updated.
...
int img2sif(
  ...
  IMG *img,
  /** Pointer to SIF. Must be initiated with sifInit(), but SIF is allocated
   *  here if necessary */
  SIF *sif,
  /** Select whether SIF header contents are copied (1) or not (0) */
  int copy_header,
