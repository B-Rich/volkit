/******************************************************************************
  ...
  ecat63w.c  (c) 2003-2013 by Turku PET Centre
  ...
  2003-07-21 Vesa Oikonen
    Created based on previous contents of ecat63.c.
  2003-09-08 VO
    Added function ecat63WriteImageMatrix() and ecat63WriteScanMatrix().
  2003-11-30 VO
    For now, calls temp_roundf() instead of roundf().
  2004-01-07 VO
    ecat63WriteImageMatrix(): corrected img min&max in header.
  2004-09-17 VO
    Doxygen style comments.
  2004-12-28 VO
    Included function ecat63_is_scaling_needed().
  ...
  2007-01-27 VO
    Unsigned char pointer was corrected to signed in ecat63WriteMatdata().
  2007-09-02 VO
 ...
 * 8 failed to resolve new matrix block number, 10 failed to write image sub header, 
