/******************************************************************************
  ...
  Library:      imgdecay
  Description:  Functions for working with physical decay and isotopes in IMG.
  ...
  2007-02-01 Vesa Oikonen
    ...
    Functions now apply libtpcmisc 1.2.0 as far as possible.
    Added function imgSetDecayCorrFactors().
  2008-07-07 VO
    Decay correction functions check (superficially) that image data contains
    frames times.
  2012-02-24 VO
    Added function imgBranchingCorrection().
  2012-09-21 VO
