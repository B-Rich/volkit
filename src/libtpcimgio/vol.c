/******************************************************************************
  ...
  2012-08-20 VO
    Bugs fixed:_col is not freed because points to the same memory as _vxl.
  2012-10-19 VO
    Added functions vrdRead(), vrdReorder(), and string_to_xyz().
  2012-10-23 VO
    Interfaces of volAvg() and volMax() changed: parameter r is given as
    pointer; NULL can be given if r is to be ignored.
