/*******************************************************************************
  ...
  2012-02-04 VO
       First argument of upetExists() was changed from char* to const char*.
       Part of contents moved into new file img_upet.c.
  2012-02-19 VO
       Added function upetReadImagedata().
...
\return Returns 0 if parameter was found, even if value is empty, and 1, if
  parameter was not found, and <0 in case of other errors
 */
